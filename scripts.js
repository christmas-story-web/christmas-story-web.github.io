...
function clickNav(bodyClicked) {
    ...
    if (navIconWasClicked || bodyClicked) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // respond to clicks on the nav icon
